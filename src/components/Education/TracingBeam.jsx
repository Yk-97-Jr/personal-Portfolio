...
export const TracingBeam = ({ children }) => {
  ...
  useLayoutEffect(() => {
    const handleSVGheight = () => {
      contentRef.current &&
        setSvgHeight(contentRef.current.offsetHeight * 1.05);
    };
    handleSVGheight();
      ...
      <div className="absolute -left-0 xl:-left-20 2xl:-left-[11rem] -top-11  hidden sm:block">
        ...
        >
          <motion.div
            ...
            animate={{
              backgroundColor:
                scrollYProgress.get() > 0 ? "violet" : "var(--emerald-500)",
        ...
        >
          ...
          <defs>
            ...
            >
              <stop
                stopColor={mode === "dark" ? "#18CCFC" : "#60DDFF"}
                stopOpacity="0"
              ></stop>
              <stop stopColor={mode === "dark" ? "#18CCFC" : "#60DDFF"}></stop>
              <stop
                offset="0.325"
                stopColor={mode === "dark" ? "#6344F5" : "#856BFF"}
              ></stop>
              <stop
                offset="1"
                stopColor={mode === "dark" ? "#AE48FF" : "#C276FF"}
                stopOpacity="0"
              ></stop>
            </motion.linearGradient>
          </defs>
