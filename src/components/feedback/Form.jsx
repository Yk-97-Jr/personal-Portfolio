...
const Form = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const serviceID = "service_9elhfuo";
    const templateID = "template_zbb4f51";
    const publicKey = "w6e2kkR8RV1rYBSp8";
  ...
  return (
    <>
      ...
      >
            ...
            <input
              ...
              className={`w-full md:w-1/3 rounded-full pl-6 pr-4 py-[12px] text-[14px] ${
                mode === "dark"
                  ...
                  : "text-violet-600 bg-violet-200 focus:ring-indigo-700 placeholder:text-violet-400"
        ...
        <motion.div
          variants={childVariants}
          className="mt-9 flex items-center justify-between mb-7 xl:mb-0"
        >
          <button
            type="reset"
            onClick={handleReset}
          ...
          >
            ...
            <div
              className={`rounded-full ${
                mode === "dark" ? "bg-indigo-800" : "bg-indigo-400"
              } p-3 text-xl`}
            >
              <RxReset />
            </div>
