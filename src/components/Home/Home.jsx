...
import mySelf from "../../assets/me1.png";
import mySelf2 from "../../assets/me.jpg";
...
const Home = () => {
  ...
  const text =
    "Hey there! I'm Youcef Frontend  Developer specializing in React";
        ...
        >
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center px-3 md:p-6 2xl:px-[140px] 2xl:pr-[170px] gap-x-10 2xl:gap-x-[120px] sm:gap-y-[50px] min-h-screen">
            ...
            >
              <Tilt className="">
                <div
                  className={`max-w-[350px] xl:max-w-[900px] min-w-[200px] sm:min-w-[400px] 2xl:min-w-[532px] lg:min-w-[450px] xl:min-w-[500px] 3xl:min-w-[600px] 3xl:min-h-[600px] rounded-full overflow-hidden box `}
                >
                  <img
                    src={mode === "dark" ? mySelf : mySelf2}
                    className={`w-full h-full rounded-full ${
                      mode === "dark" ? "border border-darkBlue" : ""
                    } `}
                  />
                </div>
              </Tilt>
            ...
            <div className="space-y-6 xl:space-y-5 flex flex-col items-center lg:items-start justify-center sm:px-[60px] md:px-0 mb-5">
                ...
                {text.split(" ").map((item, index) => (
                  <motion.span
                    ...
                    className={`inline-block md:tracking-wide ${
                      mode === "dark" ? "text-green-300" : "text-blue-950"
              ...
              >
                As a skilled frontend developer, I'm all about bringing ideas to
                life on the web. Explore my latest projects , showcasing my
              ...
              >
                ...
                <a href="mailto:youcefkhalfi5@gmail.com">
                  <span
                    className={`border-b-2 pb-1 ${
                      mode === "dark" ? "border-b-white" : "border-b-black"
