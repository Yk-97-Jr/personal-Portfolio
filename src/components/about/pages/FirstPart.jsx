...
const FirstPart = () => {
  ...
  const longBiography = [
    `Meet Youcef Khalfi JR`,
    `Age: 27`,
    `Im Youcef Khalfi JR   and I'm all about frontend  and backend and  coding and problem-solving,  bringing creativity and technical expertise to every project`,
    ,
    `  My journey began in 2022 with a master's degree in math and algebra, leading me to dive into computer science. I started with CS50 Introduction to Computer Science and CS50 Web on edX, then delved into frontend development with Pluralsight's JavaScript courses. I honed my skills with Udemy and Zero To Mastery, completing the Complete React Developer course. Now, I'm comfortable with various web dev tools like HTML, CSS, JavaScript, Sass, and frameworks like React and Tailwind CSS. Ready to tackle challenges and leave my mark in web development.
`,
    `One of Youcef's strengths lies in his mastery of modern frontend tools and frameworks. He has successfully integrated Firebase into his projects, leveraging its real-time database and authentication services. His expertise in crafting visually appealing and responsive designs is complemented by his skillful use of Tailwind CSS and SASS.`,
  ];
  const shortBiography = [
    `Meet Soumya Sankar Das`,
    `Age: 27`,
    `At the age of 26, Youcef has already made a mark in the field of web development with his comprehensive knowledge of HTML, CSS, and JavaScript. His proficiency extends to the popular React library, Firebase allowing him to craft dynamic and interactive user interfaces. He is well-versed in version control using Git and GitHub.`,
  ...
  const [biography, setBiography] = useState(
    window.innerWidth >= 1024 ? longBiography : shortBiography
  );
  ...
  useLayoutEffect(() => {
    ...
    return () => window.removeEventListener("resize", handleBiography);
  }, []);
      ...
      <div className="w-full flex flex-col-reverse md:flex-row items-start justify-between gap-10 4xl:gap-x-24">
        ...
        <motion.div
          className={` rounded-2xl overflow-hidden border-2 p-6 ${
            mode === "dark"
              ? "border-lighter bg-darkBlue  drop-shadow-mdDark"
              : "border-darkSlate bg-slate-400 drop-shadow-mdLight"
      ...
      >
        {isInView && (
          <>
            ...
            >
              <div className="text-4xl md:text-6xl 2xl:text-7xl font-bold ">
                <CountUp start={0} end={16} />+
              </div>
              <div className="text-[13px] text-center 2xl:w-[180px] sm:text-[17px] 2xl:text-lg ">
                Projects completed
              </div>
            </motion.div>
            ...
            >
              <div className="text-4xl md:text-6xl 2xl:text-7xl font-bold ">
                <CountUp start={0} end={1} decimals={1} />+
              </div>
              <div className="text-[13px] text-center 2xl:w-[180px] sm:text-[17px] 2xl:text-lg ">
                Years of Experience
              </div>
