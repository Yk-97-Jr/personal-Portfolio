  ...
  return (
    <>
      {loading ? (
        ...
        <div
          className={`${mode === "dark" ? "bg-darkSlat text-lighter" : ""} ${
        ...
        >
          ...
          {/* heading */}
          <div
            className={` text-center text-[27px] sm:text-6xl md:text-[80px] font-extrabold 2xl:text-8xl pt-8 xl:pt-14  lg:pt-16 lg:px-20 tracking-wide ${
              mode === "dark" ? "text-indigo-400" : "text-indigo-500"
            } `}
            ref={containerRef}
          >
            <TextReveal child={`My Journey to Mastery`} />
          </div>
